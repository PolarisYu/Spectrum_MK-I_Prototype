...
int main(void)
{
  ...
  /* Initialize System Status (LEDs) */
  System_Status_Init();
  
  /* Initialize Power Management System */
  Power_Init();

  /* Reset AMP Enable Pins */
...
/* USER CODE BEGIN 4 */
/* Note: EXTI callbacks and SPI callbacks have been moved to Application/Core/app_hooks.c */
/* USER CODE END 4 */
